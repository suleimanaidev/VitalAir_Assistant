...
export default function HealthGuidanceIllustration({
  ...
  return (
    <svg
      ...
      aria-hidden
    >
      <rect width="280" height="160" rx="12" fill="var(--bg-card)" />
      ...
      <path
        ...
        strokeWidth="1.5"
      />
      <rect x="133" y="68" width="14" height="45" rx="3" fill="var(--text-muted)" />
      {/* Mask */}
      <rect x="108" y="88" width="64" height="14" rx="7" fill="var(--brand)" opacity="0.6" />
      {/* AQI badge */}
      <rect x="195" y="24" width="58" height="32" rx="8" fill="var(--bg-page)" stroke="#ffa500" strokeWidth="1.5" />
      ...
      <text x="140" y="28" textAnchor="middle" fill="var(--text-muted)" fontSize="10">
